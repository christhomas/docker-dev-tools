...
switch(true){
	...
	case DistroDetect::isUbuntu('16.04'):
	case DistroDetect::isUbuntu('16.10'):
	...
	case DistroDetect::isUbuntu('18.04'):
	case DistroDetect::isUbuntu('18.10'):
		$container->singleton(IpServiceInterface::class, \DDT\Network\Linux\IpService::class);
